...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="{{ url('assets/img/logo-big.png') }}" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="index.html" method="post">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label visible-ie8 visible-ie9">Your NIK</label>
            ...
            <form class="register-form" action="index.html" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Your NIK" name="nik" /> </div>
                <div class="form-group">
...
<![endif]-->
        ...
        <script src="{{ url('assets/scripts/login.min.js') }}" type="text/javascript"></script>
